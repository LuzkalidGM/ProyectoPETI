...
<body>
    <div class="login-container">
        ...
        <div class="form-panel">
            ...
            <div class="tab-container">
                <button id="login-tab" class="tab-button active" data-tab="login-content">Iniciar Sesión</button>
                <button id="register-tab" class="tab-button" data-tab="register-content">Registrarse</button>
            </div>
            
            <!-- Contenido de Login -->
            <div id="login-content" class="form-content active">
                <form id="loginForm" method="POST" action="../../../ProyectoPETI/Controllers/AuthController.php?action=login">
            ...
            <div id="register-content" class="form-content">
                <form id="registerForm" method="POST" action="../../../ProyectoPETI/Controllers/AuthController.php?action=register">
                    <div class="form-group">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Evento click para pestaña de login
            ...
            // Evento click para pestaña de registro
